...
public final class UIStyles {
     ...
     *
     * @return URL externa del recurso {@code /ui/css/hud.css}
     */
    public static String hud() {
        return UIStyles.class.getResource("/ui/css/hud.css").toExternalForm();
    }

    /**
     * Devuelve la hoja de estilos CSS de la vista de juego.
     *
     * @return URL externa del recurso {@code /ui/css/game.css}
     */
    public static String game() {
        return UIStyles.class.getResource("/ui/css/game.css").toExternalForm();
    }

    /**
     * Devuelve la hoja de estilos CSS global.
     *
     * @return URL externa del recurso {@code /ui/css/global.css}
     */
    public static String global() {
        return UIStyles.class.getResource("/ui/css/global.css").toExternalForm();
    }
    ...
    public static void applyDialogStyle(DialogPane dp) {
        ...
        addStylesheet(dp, "/ui/css/global.css");
        addStylesheet(dp, "/ui/css/dialogs.css");
    }
     ...
     * @param resourcePath ruta del recurso (por ejemplo {@code "/ui/css/global.css"})
     */
